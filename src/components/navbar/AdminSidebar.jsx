...
<Grid item size={{ xs: 12, md: 12 }} sx={{ backgroundColor: 'white', minHeight: '100vh', padding: 0 }}>
    ...
    <Grid container sx={{display:'flex', justifyContent:'center', alignItems:'center'}} mt={4} >
            ...
            <img src="/stick-ink/images/stickink-logo2.svg" alt="image" width='60%' />
    ...
    <Grid container sx={{display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center'}} mt={3}>
        <List>
            <ListItem button sx={{ gap:'10px', cursor:'pointer'}} onClick={()=>handleNavigation('/dashboard')}>
               <IconButton sx={{backgroundColor:'#FF0000',borderRadius:'30%', justifyContent:'center', width:'25%'}}><img src="/stick-ink/images/home-icon.svg" alt="image" width='100%' /></IconButton> 
            ...
            <IconButton sx={{backgroundColor:'#FF0000',borderRadius:'30%', justifyContent:'center', width:'25%'}}><img src="/stick-ink/images/product-icon.svg" alt="image" width='100%' /></IconButton> 
            ...
            <IconButton sx={{backgroundColor:'#FF0000',borderRadius:'30%', justifyContent:'center', width:'25%'}}><img src="/stick-ink/images/vehicle-icon.svg" alt="image" width='100%' /></IconButton> 
            <Typography  sx={{fontSize:'14px'}}>Vehicle</Typography>
            </ListItem>

            <ListItem button sx={{gap:'10px',cursor:'pointer'}}>
            <IconButton sx={{backgroundColor:'#FF0000',borderRadius:'30%', justifyContent:'center', width:'25%'}}><img src="/stick-ink/images/document-text.svg" alt="image" width='100%' /></IconButton> 
